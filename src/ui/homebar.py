...
class App(customtkinter.CTk):
    ...
    def show_home_frame(self):
        ...
        self.manageScrappers_button = customtkinter.CTkButton(master=self.sidebar_frame, fg_color="transparent", border_width=2, text_color=("gray10", "#DCE4EE"), text="Manage Scrappers", command=lambda : self.openManageScrappers())
        self.manageScrappers_button.grid(row=8, column=0, padx=(20, 20), pady=(20, 20))
    ...
    def show_edit_scrapper_frame(self):
        ...
        self.name_label.grid(row=1, column=0, padx=(20,20), pady=(0,0),sticky="w")
        self.name_entry = customtkinter.CTkEntry(self.edit_scrapper_frame)
        self.name_entry.grid(row=2, column=0,padx=(20,20), pady=(0,0), sticky="we")
        ...
        # Save button
        save_button = customtkinter.CTkButton(self.edit_scrapper_frame, text="Edit")
        save_button.grid(row=7, columnspan=2, pady=(30,30))
